...
const content = [
  ...
  '-- - After applying this SQL, run npm.cmd run external:check:supabase and npm.cmd run auth:supabase-smoke when',
  '--   SUPABASE_JWT_SECRET is configured on the API.',
  '',
  ...
  JSON.stringify(
    {
      ...
      nextSteps: [
        ...
        'Run npm.cmd run auth:supabase-smoke after the API is running with SUPABASE_JWT_SECRET.',
      ],
    },
    null,
    2,
